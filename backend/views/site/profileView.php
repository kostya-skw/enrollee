...
<div class="col-lg-3 border">
    ...
    <div style="padding-top: 15px;">
        <?= Html::a(
            '<i class="glyphicon glyphicon-pencil" style="font-size: 12pt;"></i> '.Yii::t('app', 'Изменить'),
            ['site/profile-edit', 'id'=>$model['id']],
            ['class' => 'btn btn-flat btn-primary btn-block']) ?><br/>

        <?= Html::a(
            '<i class="glyphicon glyphicon-file" style="font-size: 12pt;"></i> '.Yii::t('app', 'в PDF'),
            ['site/profile-to-pdf', 'id'=>$model['id']],
            ['class' => 'btn btn-flat btn-info btn-block']) ?><br/>
    </div>
